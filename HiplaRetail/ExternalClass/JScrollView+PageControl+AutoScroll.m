...
//        self.backgroundColor = [UIColor yellowColor];
        ...
        [firstView setAutoresizingMask:UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight];
        [middleView setAutoresizingMask:UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight];
        [lastView setAutoresizingMask:UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight];
...
-(void)autoShowNext
{
    ...
    [_scrollView setContentOffset:CGPointMake(self.bounds.size.width*(_currentPage - 1), 0) animated:YES];
}
...
-(void)reloadData
{
    ...
    CGSize scrollSize = _scrollView.bounds.size;   //_scrollView.bounds.size;
